...
export default function PricingCards({ locale = "ru" }: { locale?: Locale }) {
  ...
  const T = en
    ...
    : { forever: "навсегда", mo: "/мес", freeItems: ["Натальная карта с колесом", "Краткие описания планет"], lockedFree: ["Полные интерпретации", "Гороскопы, совместимость, матрица", "Соляр"], startFree: "Начать бесплатно", allFree: "Всё из Free", stars: "звёзд в месяц", fullAi: "Полные AI-интерпретации", stdSet: "Гороскопы, совместимость, матрица, Oracle", solar: "Соляр", chooseStd: "Выбрать Standard", allStd: "Всё из Standard", solarYear: "Соляр — прогноз на личный год", oraclePrio: "Приоритетные ответы Oracle", choosePrem: "Выбрать Premium", na: " — недоступно в этом тарифе" };
