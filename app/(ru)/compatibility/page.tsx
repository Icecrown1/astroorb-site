...
const FAQ_ITEMS = [
  ...
  { q: "Нужна ли дата рождения партнёра?", a: "Для разбора по знакам — нет, достаточно знаков. Для точной синастрии в AstroOrbi нужны даты рождения обоих; время — желательно, но не обязательно." },
];
        ...
        <Reveal delay={150}>
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center rounded-2xl border border-hairline bg-surface p-6">
            <p className="text-sm sm:flex-1 text-muted">
              Всего на сайте — 78 пар знаков. Точная синастрия по двум картам считается в AstroOrbi.
