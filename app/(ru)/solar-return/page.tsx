...
const FAQ_ITEMS = [
  ...
  { q: "Влияет ли место встречи дня рождения на соляр?", a: "Да, дома соляра строятся по месту, где вы находитесь в момент солнечного возвращения. AstroOrbi считает карту по вашему актуальному местоположению и кэширует расчёт на год." },
      ...
      <section className="mx-auto max-w-3xl px-4 pt-8">
        ...
        <Reveal>
          <div className="mt-12 space-y-4 text-[15px] leading-relaxed text-muted">
            ...
            <p>
              AstroOrbi вычисляет момент солнечного возвращения астрономически точно (Swiss Ephemeris),
