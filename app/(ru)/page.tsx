...
export const metadata: Metadata = {
  title: "Натальная карта с точностью NASA — AI-астролог AstroOrbi в Telegram",
  description:
...
const HOME_FAQ = [
  ...
  { q: "Нужно ли устанавливать приложение?", a: "Нет. AstroOrbi работает как Mini App прямо внутри Telegram — на телефоне и на компьютере. Один клик по кнопке — и карта строится." },
              ...
              <table className="w-full text-[13px] sm:text-sm">
                ...
                <tbody>
                  ...
                  <tr className="bg-iris/[0.06]">
                    <td className="p-3 align-top sm:p-5 font-medium">AstroOrbi</td>
