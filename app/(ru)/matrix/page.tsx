...
const FAQ_ITEMS = [
  ...
  { q: "Что входит в полный разбор в AstroOrbi?", a: "Все позиции матрицы с плюс- и минус-проявлениями каждой энергии, задачи по возрастам, финансовый канал и совместимость матриц — плюс возможность задавать вопросы AI по вашему раскладу." },
];
        ...
        <Reveal>
          ...
          <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted">
            ...
            <p>
              ...
              финансовым каналом доступен в AstroOrbi — вместе с натальной картой, чтобы увидеть себя сразу в двух системах.
            </p>
          </div>
        </Reveal>
      </section>
